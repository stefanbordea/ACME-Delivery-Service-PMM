...
public interface ProductRepository extends JpaRepository<Product, Long> {
	...
	@Query (value = "SELECT SUM(ORDER_ITEMS.QUANTITY) AS QUANTITY, PRODUCTS.NAME AS PRODUCTS " +
			"FROM ORDER_ITEMS INNER JOIN PRODUCTS ON ORDER_ITEMS.PRODUCT_ID=PRODUCTS.ID GROUP BY PRODUCTS.NAME " +
